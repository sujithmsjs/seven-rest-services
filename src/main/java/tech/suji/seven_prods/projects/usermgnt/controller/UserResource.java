package tech.suji.seven_prods.projects.usermgnt.controller;
...
import tech.suji.seven_prods.projects.usermgnt.service.UserService;
...
public class UserResource {
    ...
    @GetMapping("/{id}/status/{flag}")
    public boolean updateStatus(@PathVariable Long id, @PathVariable Boolean flag ) {
