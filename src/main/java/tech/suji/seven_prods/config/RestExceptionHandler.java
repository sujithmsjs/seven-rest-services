...
import tech.suji.seven_prods.model.ErrorResponse;
import tech.suji.seven_prods.model.FieldError;
...
public class RestExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> handleResponseStatus(final DataIntegrityViolationException exception) {
		final ErrorResponse errorResponse = new ErrorResponse();
		errorResponse.setHttpStatus(422);
		errorResponse.setException(exception.getClass().getSimpleName());
		errorResponse.setMessage(exception.getMessage());
	...
	public ResponseEntity<ErrorResponse> handleCustomException(CustomException ex) {
		final ErrorResponse errorResponse = new ErrorResponse();
		errorResponse.setException(ex.getClass().getCanonicalName());
